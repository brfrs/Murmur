...
class CreateServerMenu(Frame):
	"""
	Spawns a menu for you to create the server. It should provide all necessary
	input validation.
	"""
	...
	def try_to_create_server(self):
		"""
		Uses the values entered in the port and username to create a server
		with the given function. If the input of either is invalid, an errror
		message will be written and the server will not be instantiated.
		"""
